...
// import { verifyEmail as verifyEmailApi, resendVerificationEmail } from "../../services/api/auth";
...
//         if (accessToken && response?.userId && response?.email && response?.fullName) {
...
//             </div>
//             <span className="text-base font-bold text-slate-800">InventoryPro</span>
//           </Link>
//         </motion.div>
...
//           transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
//         >
//           {/* Animated accent bar that changes color with status */}
//           <motion.div
//             className={`h-1 w-full bg-gradient-to-r ${accentBar[status]}`}
//             layout
...
//                     <Mail className="relative h-6 w-6 text-indigo-400" strokeWidth={1.8} />
//                   </div>
...
//                     />
//                   </div>
//                   <p className="mt-2 text-xs text-slate-300">Redirecting in 2s…</p>
//                 </motion.div>
//               )}
...
//                     transition={{ type: "spring", stiffness: 220, damping: 14, delay: 0.1 }}
//                   >
//                     <XCircle className="h-8 w-8 text-red-400" strokeWidth={1.8} />
//                   </motion.div>
...
//                         disabled={resending}
//                         className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-200/60 transition disabled:cursor-not-allowed disabled:opacity-60"
//                         whileHover={{ scale: 1.01, boxShadow: "0 8px 25px rgba(99,102,241,0.4)" }}
//                         whileTap={{ scale: 0.98 }}
//                       >
